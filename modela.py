...
dataset_train = pd.read_csv('Apple_Stock_Clean.csv')
...
X_train = []
y_train = []
for i in range(PAST_DAYS, len(training_set_scaled)):
...
plt.title(f'Apple Stock Price Prediction ({PAST_DAYS} Day Lookback)')
