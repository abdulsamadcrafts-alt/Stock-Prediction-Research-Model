...
=======
# Stock Price Prediction using LSTM (Google & Apple)
...
3. Create time-series sequences using past N days
4. Train LSTM model on sequences
5. Predict future stock prices
6. Compare predicted vs real values using plots
...
├── Apple_Stock_Clean.csv
├── Apple_Stock_Price_Test.csv
├── model.py
├── regressor.pkl
└── README.md
...
## ⚠️ Disclaimer
This project is for educational purposes only and should not be used for real financial trading decisions.
>>>>>>> 61f84a8ad18143984b23e0024efd54ced524c4fc
